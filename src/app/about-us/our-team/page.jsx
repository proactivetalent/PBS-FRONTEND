...
const Page = () => {
  ...
  useEffect(() => {
    const detectZoomAndAdjustText = () => {
      // Detect zoom level by comparing window.devicePixelRatio
      const zoomLevel = Math.round(window.devicePixelRatio * 100);

      if (zoomLevel <= 100) {
        // 100% zoom or less - use larger text (xl)
        setTextSize('text-xl');
      } else if (zoomLevel >= 125) {
        // 125% zoom or more - use smaller text (md)
        setTextSize('text-md');
      } else {
        // Between 100-125% - use base text
        setTextSize('text-base');
      }
    };

    // Run on component mount
    detectZoomAndAdjustText();

    // Run on zoom change
    window.addEventListener('resize', detectZoomAndAdjustText);

    // Cleanup
    return () => {
      window.removeEventListener('resize', detectZoomAndAdjustText);
    };
  }, []);
  ...
  return (
    <div className="bg-[#37403D] min-h-screen overflow-hidden">
      ...
      <div className="px-4 md:px-6 lg:px-12 xl:px-16 py-8 flex justify-center">
        <div className="flex flex-col lg:flex-row justify-center items-stretch gap-3 md:gap-4 lg:gap-12 w-full max-w-7xl">
          {/* CEO Image Section */}
          <div className="w-[80vw] md:w-[80vw] lg:w-2/5 flex flex-col justify-start items-center space-y-4 h-full md:h-full lg:h-[80vh] mx-auto">
            {/* Header Section */}
            <div className="w-full h-[25%] bg-[#1E2322] rounded-2xl lg:rounded-3xl sm:rounded-3xl px-4 md:px-6 py-4 md:py-6 flex flex-row justify-center items-center gap-3 md:gap-4 shadow-lg shadow-black/20 backdrop-blur-sm border border-white/5">
              <div className="flex justify-center items-center">
                <img className="w-16 md:w-20 lg:w-24 h-auto" src="/PBS Assets/About Us/Our Team/CEO.png" alt="CEO" />
              </div>
              <h2 className="font-conthrax text-2xl md:text-2xl lg:text-3xl font-semibold text-white text-center leading-tight flex-1">Message From Executive Director</h2>
            </div>
            
            {/* CEO Info Section */}
            <div className="w-full h-auto min-h-[40%] md:h-auto md:min-h-[50%] lg:h-[75%] bg-gradient-to-br from-[#1E2322] via-[#1E2322] to-[#2A2F2E] hover:from-[#2A2F2E] hover:via-[#1E2322] hover:to-[#1E2322] rounded-[40px] py-6 md:py-6 lg:p-8 flex flex-col justify-center shadow-xl shadow-black/25 backdrop-blur-sm border border-white/10 hover:shadow-2xl hover:shadow-black/30 transition-all duration-300">
              <div className="w-full flex flex-col items-center md:items-center lg:items-start text-center md:text-center lg:text-left space-y-0 md:space-y-0">
                <h1 className="font-conthrax text-2xl md:text-3xl lg:text-5xl font-semibold text-[#8AD5B7]">{CEO_data.name}</h1>
                 <p className="font-semibold text-white text-sm pb-2 sm:pb-2 md:pb-2 lg:pb-10 md:text-base lg:text-lg font-poppins">{CEO_data.title}</p>
                <div className={`text-[#89A096] text-center md:text-center lg:text-left font-light leading-relaxed ${textSize}`}>
            ...
            <div className="w-full h-auto min-h-[40vh] md:h-auto md:min-h-[50vh] lg:h-[80vh] bg-[#1E2322] rounded-[40px] p-3 md:p-4 lg:p-5 flex flex-col justify-start overflow-y-auto scrollbar-hide shadow-xl shadow-black/25 backdrop-blur-sm border border-white/10 hover:shadow-2xl hover:shadow-black/30 transition-all duration-300">
              ...
              <div className={`text-[#89A096] font-light leading-relaxed text-left text-sm md:text-base lg:text-lg ${textSize}`}>
                ...
                <div className="mt-6">
                  ...
                  <p className="font-semibold text-white">Jon Credendino</p>
                  <p className="font-semibold text-white">Executive Director</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="w-1/2 md:w-[80%] mx-auto mb-10 h-[2px] bg-[#1E2322]/70 rounded-full"></div>
      ...
      <div className="py-4 xl:py-6 ">
        <section className="w-[100%]">
          ...
          <div className="px-4 md:px-6 lg:px-12 xl:px-16 flex justify-center">
            <div className="flex flex-col lg:flex-row justify-center items-start gap-4 md:gap-6 lg:gap-8 w-full max-w-7xl">

              {/* Leadership Image Section */}
              <div className="mb-8 w-full lg:w-1/3 flex flex-col justify-center items-center">
                <div className="h-[40vh] md:h-[35vh] lg:h-[40vh] w-full max-w-sm lg:max-w-none bg-[#1E2322] rounded-[40px] shadow-xl shadow-black/25 backdrop-blur-sm border border-white/10 hover:shadow-2xl hover:shadow-black/30 transition-all duration-300">
                  <div className="w-full h-full flex flex-col justify-center items-center">
                    <img className="w-[30%] h-auto" src="/PBS Assets/About Us/Our Team/leadership.png" alt="Leadership" />
                    <h2 className="font-conthrax text-2xl md:text-3xl lg:text-4xl font-semibold text-white text-center mt-4 mx-6">Leadership Team</h2>
                  </div>
                </div>
              </div>
              {/* Leadership Team Cards Grid 3*2 - Hidden on mobile */}
              <div className="hidden lg:flex w-full lg:w-2/3 flex flex-col justify-center">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6">
                  {leadershipTeam.map((member, index) => (
                    ...
                    >
                      <div className="w-full flex flex-col justify-stretch gap-1 text-start p-2">
                        <h3 className="text-xl md:text-lg xl:text-2xl text-start font-conthrax font-semibold text-[#8AD5B7]">
                          {member.name}
                        </h3>
          ...
          <div className="px-4 md:px-6 lg:px-12 xl:px-16">
            <div className="flex flex-col lg:flex-row justify-center items-start gap-4 md:gap-6 lg:gap-8 mx-auto max-w-7xl">
              ...
              <div className="mb-8 w-full lg:w-1/3 flex flex-col justify-center items-center">
                <div className="h-[40vh] md:h-[35vh] lg:h-[40vh] w-full max-w-sm lg:max-w-none bg-[#1E2322] rounded-[40px] shadow-xl shadow-black/25 backdrop-blur-sm border border-white/10 hover:shadow-2xl hover:shadow-black/30 transition-all duration-300">
                  <div className="w-full h-full flex flex-col justify-center items-center">
                    ...
                    <h2 className="font-conthrax text-2xl md:text-3xl lg:text-4xl font-semibold text-white text-center mt-4 mx-6">Project Managers</h2>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 w-full lg:w-1/3 flex flex-col justify-center items-center">
                <div className="h-[40vh] md:h-[35vh] lg:h-[40vh] w-full max-w-sm lg:max-w-none bg-[#1E2322] rounded-[40px] shadow-xl shadow-black/25 backdrop-blur-sm border border-white/10 hover:shadow-2xl hover:shadow-black/30 transition-all duration-300">
                  <div className="w-full h-full flex flex-col justify-center items-center">
                    ...
                    <h2 className="font-conthrax text-2xl md:text-3xl lg:text-4xl font-semibold text-white text-center mt-4 mx-6">Admin Team</h2>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 w-full lg:w-1/3 flex flex-col justify-center items-center">
                <div className="h-[40vh] md:h-[35vh] lg:h-[40vh] w-full max-w-sm lg:max-w-none bg-[#1E2322] rounded-[40px] shadow-xl shadow-black/25 backdrop-blur-sm border border-white/10 hover:shadow-2xl hover:shadow-black/30 transition-all duration-300">
                  <div className="w-full h-full flex flex-col justify-center items-center">
                    ...
                    <h2 className="font-conthrax text-2xl md:text-3xl lg:text-4xl font-semibold text-white text-center mt-4 mx-6">Expediting & Compliance</h2>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 w-full lg:w-1/3 flex flex-col justify-center items-center">
                <div className="h-[40vh] md:h-[35vh] lg:h-[40vh] w-full max-w-sm lg:max-w-none bg-[#1E2322] rounded-[40px] shadow-xl shadow-black/25 backdrop-blur-sm border border-white/10 hover:shadow-2xl hover:shadow-black/30 transition-all duration-300">
                  <div className="w-full h-full flex flex-col justify-center items-center">
                    ...
                    <h2 className="font-conthrax text-2xl md:text-3xl lg:text-4xl font-semibold text-white text-center mt-4 mx-6">Accounting Team</h2>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 w-full lg:w-1/3 flex flex-col justify-center items-center">
                <div className="h-[40vh] md:h-[35vh] lg:h-[40vh] w-full max-w-sm lg:max-w-none bg-[#1E2322] rounded-[40px] shadow-xl shadow-black/25 backdrop-blur-sm border border-white/10 hover:shadow-2xl hover:shadow-black/30 transition-all duration-300">
                  <div className="w-full h-full flex flex-col justify-center items-center">
                    ...
                    <h2 className="font-conthrax text-2xl md:text-3xl lg:text-4xl font-semibold text-white text-center mt-4 mx-6">Marketing Team</h2>
                  </div>
                </div>
              </div>
