    ...
    <section className="rounded-3xl">
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-center lg:items-start">
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
          <img
            src="/PBS Assets/alertguide/guide4/intro.webp"
            alt="Introduction"
      ...
      <div className="flex flex-col">
        ...
        <div className="flex my-10 gap-8 flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 flex justify-center items-center">
            <img src="/PBS Assets/alertguide/guide4/interface.webp" alt="Accessing Property Profile" className="w-full h-auto object-contain" />
          </div>
        </div>
      ...
      <section className="rounded-3xl">
        <div className="flex flex-col text-[#C5D3CD]">
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-center items-center">
            ...
            <div className="w-full lg:w-1/2">
              <img src="/PBS Assets/alertguide/guide4/custom_inspection.webp" alt="Settings" className="w-full h-auto object-contain" />
            </div>
          </div>
